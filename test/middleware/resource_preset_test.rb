...
class ResourcePresetMiddlewareTest < Minitest::Test
  ...
  def test_injects_small_preset_into_deployment
    ...
    result = Middleware::ResourcePreset.new.call(resource)
    container = result.to_h.dig(:spec, :template, :spec, :containers, 0)
  ...
  def test_raises_on_unknown_size
    ...
    error = assert_raises(ArgumentError) do
      Middleware::ResourcePreset.new.call(resource)
    end
